...
Projeto da disciplina de Computação Gráfica (UNICAP). Implementação interativa de um Cubo Mágico (Rubik's Cube) 3×3×3 em Three.js, com câmera 3D e animação suave ao girar as faces.
